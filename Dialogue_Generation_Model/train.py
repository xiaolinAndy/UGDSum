...
from transformers import (OpenAIGPTLMHeadModel, OpenAIGPTConfig, GPT2LMHeadModel, GPT2Config,
                          WEIGHTS_NAME, CONFIG_NAME, AdamW, BertTokenizer, GPT2Tokenizer)
...
def train():
    ...
    parser.add_argument("--dataset", type=str, default='CSDS')
    ...
    if args.local_rank in [-1, 0]:
        ...
        checkpoint_handler = ModelCheckpoint(tb_logger.writer.logdir, 'checkpoint', save_interval=1, n_saved=100)
